...
namespace GroceryList
{
	...
	public class MainActivity : Activity
	{
		...
		{
            //create an Intent object that is passed the context fromt he current 
            //activity and the explicit Activity to be started 
		...
		{
            //the conveneice method for starting an Activity            
